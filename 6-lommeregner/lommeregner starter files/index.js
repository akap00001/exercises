...
function klik(evt) {
  ...
  if (typeOfInput === "num") {
    ...
    const tal1 = parseInt(firstNumVal);
    const tal2 = parseInt(secondNumVal);
    let result;
...
if (regneArt === "+") {
  ...
  // EKSTRA OPGAVE
  // Hvis du bliver færdig, kan du prøve at:
  //   •    forhindre flere regnearter i træk
  //   •    genbruge resultatet som første tal efter =
  //   •    håndtere division med 0
  //   •    rydde displayet automatisk ved ny beregning
